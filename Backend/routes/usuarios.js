...
router.post("/usuarios", async (req, res) => {
 try {
   const nombre = normalizeText(req.body.nombre || req.body.Nombre || req.body.name);
   const usuario = normalizeText(req.body.usuario || req.body.Usuario || req.body.username);
   const contrasena = normalizeText(
     req.body.contrasena ||
     req.body.Contrasena ||
     req.body.password
   );
   const correo = normalizeText(req.body.correo || req.body.Correo || req.body.email);
   const rol = normalizeRole(req.body.rol || req.body.Rol || req.body.role);
   if (!nombre) {
